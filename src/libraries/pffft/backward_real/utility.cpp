...
int fft_backward_real_config_init(size_t cache_size,
                                  config_t *&config) {
...
void fft_backward_real_input_init(int count,
                                  config_t *config,
                                  input_t **&input) {
...
void fft_backward_real_output_init(int count,
                                   config_t *config,
                                   output_t **&output) {
...
void fft_backward_real_comparer(config_t *config,
...
kernel_utility_t fft_backward_real_utility = {fft_backward_real_config_init, fft_backward_real_input_init, fft_backward_real_output_init, fft_backward_real_comparer};